...
public class ArrayList {
    ...
    public static void main(String[] args) {
        ...
        java.util.ArrayList<String> stringArrayList1 = new java.util.ArrayList<>(30); // Мы ввели размер этого массива

        //3
        java.util.ArrayList<Integer> integerArrayList1 = new java.util.ArrayList<>(integerArrayList);
